...
{
    public class GetAllVisitDetailsController : ApiController
    {
        ...
        public HttpResponseMessage Post([FromBody]Paging paging)
        {
            ...
            using (ClientContext context = new ClientContext(baseurl))
            {
                try
                {
                    ...
                    ReturnObj returnObj = VisitDetailsRepository.GetAllVisitDetails(context,paging.Position, paging.Items);
